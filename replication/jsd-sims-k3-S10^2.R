...
# This script reproduces Figures 12a-12d in the SM of the paper.
# Comment/uncomment "type" to run different tests ("jsd"/"mean"/"scatter"). The
# "Simulation" block runs the simulations (parallelized and time-consuming), and
# the "Analysis" block generates the figures. Faster outputs can be obtained by
# reducing M = 1e4 to a smaller value, e.g., M = 5e2.
