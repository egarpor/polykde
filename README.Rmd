...
The folder `/replication` contains the scripts to replicate the simulations and numerical experiments of the Supplementary Material (SM):

* The script `kde_sims.R` reproduces the asymptotic normality experiment in Section B.1 of the SM.
* The script `kde_efic.R` computes the kernel efficiency table in Section B.2 of the SM.
